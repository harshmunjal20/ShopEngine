...
const OrderSummary = () => {
   ...
   const formattedSubTotal = subTotal.toFixed(2); // to two decimal points
   ...
   const handlePayment = async () => {
      try {
         ...
         window.location.href = url; // this will redirect the user to stripe checkout
         ...
         >
            ...
            <div className='space-y-4'>
               <div className='space-y-2'>
                  {/* we used dl, dt instead of div because => better accessibility (screen readers) , more semantic (better html meaning) */}
                 ...
                 {savings > 0 &&  
                  ...
                  {/*Also we would like to show coupon if any coupon being applied */}
