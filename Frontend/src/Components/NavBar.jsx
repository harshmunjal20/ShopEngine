...
import {Link} from 'react-router-dom';  // what link does is that unlike <a> which loads the whole page but Link updates 
import {useCartStore} from '../stores/useCartStore.js';
// only the ui (spa behaviour) => single opage application
