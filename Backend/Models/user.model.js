...
userSchema.pre('save', async function () { 
    ...
    try {
        if (!this.password) return; // if password is not provided, just return and don't do anything, this is important because when user is signing up with google then they won't have password and we don't want to throw an error in that case.
